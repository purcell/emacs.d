...
(yas-define-snippets 'python-mode
                     '(("parameters"
                        ...
                        "parameters" nil nil nil "/Users/marshall/.emacs.d/snippets/python-mode/parameters" nil nil)
                       ("defd" "def ${1:function}(${2:args}):\n    \"\"\"${3:short description}\n\n    $0\n\n    ${4:Parameters\n    ----------\n    ${5:Please press the tab key twice.$(replace-regexp-in-string\n                                           \".*\" \"parameters\" yas-text)}\n    }\"\"\"\n" "defwithdoc" nil nil nil "/Users/marshall/.emacs.d/snippets/python-mode/defwithdoc" nil nil)
                       ("defg" "def ${1:name}($2):\n    \\\"\\\"\\\"$3\n    ${2:$(python-args-to-google-docstring yas-text t)}\n    ${5:Returns:\n        $6\n}\n    \\\"\\\"\\\"\n    ${0:$$(let ((beg yas-snippet-beg)\n                (end yas-snippet-end))\n        (yas-expand-snippet\n          (buffer-substring-no-properties beg end) beg end\n              (quote ((yas-indent-line nil) (yas-wrap-around-region nil))))\n            (delete-trailing-whitespace beg (- end 1)))}\n" "Python Google style Docstring" nil nil nil "/Users/marshall/.emacs.d/snippets/python-mode/defg" nil nil)))
