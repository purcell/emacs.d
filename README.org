...
- Many users complain that they have issue to fetch packages from elpa/marmalade/melpa
...
* How to use exactly the same packages I'm using without accessing elpa/marmalade/melpa
** Solution 1
