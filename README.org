* Warning
- *If you are absolutely newbie and want to use Emacs immediately, please check the section "Install packages without elpa/marmalade/melpa". Use solution 1!*.
...
Then start Emacs. Obviously you need internet connection to access github.com.
