...
- Many users complain that they have issue to fetch packages from elpa/marmalade/melpa. Check the section [[lockpackage][Use same packages as mine without elpa/marmalade/melpa]] for solutions.
...
* Use same packages as mine without elpa/marmalade/melpa<<lockpackage>>
** Solution 1
